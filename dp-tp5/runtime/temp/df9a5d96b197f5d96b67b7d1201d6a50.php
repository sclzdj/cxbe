<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:95:"D:\phpStudy\PHPTutorial\WWW\dp-tp5\public/../application/project/view/admin/category\index.html";i:1540799710;s:79:"D:\phpStudy\PHPTutorial\WWW\dp-tp5\public/../application/admin/view/layout.html";i:1540780273;s:47:"../application/common/builder/aside/layout.html";i:1540780273;s:54:"../application/common/builder/aside/blocks/recent.html";i:1540780273;s:54:"../application/common/builder/aside/blocks/online.html";i:1540780273;s:54:"../application/common/builder/aside/blocks/switch.html";i:1540780273;}*/ ?>
<!DOCTYPE html>
...
<!-- END Side Content -->
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="block">
                <div class="block-header bg-gray-lighter">
                    <b class="block-title"><?php echo $page_title; ?></b>
                    <ul class="block-options">
                        <li>
                ...
                <div class="block-content tab-content">
                    <div class="tab-pane active">
                        <?php if(!(empty($categorys) || (($categorys instanceof \think\Collection || $categorys instanceof \think\Paginator ) && $categorys->isEmpty()))): ?>
                        <div class="row data-table-toolbar">
                            <div class="col-sm-12">
                                <form action="<?php echo \think\Request::instance()->url(); ?>" method="get">
                                <div class="toolbar-btn-action">
                                    <a title="新增" class="btn btn-primary" href="<?php echo url('add'); ?>"><i class="fa fa-plus-circle"></i> 新增</a>
                        ...
                        <div class="dd" id="data_list">
                            <ol class="dd-list"><?php echo $categorys; ?></ol>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<script>
    $(document).ready(function(){
        ...
        $('#save').click(function(){
            Dolphin.loading();
            $.post("<?php echo url('save'); ?>", {data: $('#data_list').nestable('serialize')}, function(data) {
