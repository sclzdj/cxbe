<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:92:"D:\phpStudy\PHPTutorial\WWW\dp-tp5\public/../application/user/view/admin/publics\signin.html";i:1540780273;}*/ ?>
<!DOCTYPE html>
...
<!--[if gt IE 9]><!--> <html class="no-focus" lang="zh"> <!--<![endif]-->
    <head>
        ...
        <title>后台登录 | <?php echo config('web_site_title'); ?></title>
    ...
    <body>
                    ...
                    <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                        <div class="push-30-t push-50 animated fadeIn">
                            ...
                            <div class="text-center">
                                <img src="/static/admin/img/logo-signin.png" alt="后台管理系统">
                                <p class="text-muted push-15-t">后台管理系统</p>
                            </div>
                            <!-- END Login Title -->
        ...
        <div class="pulldown push-30-t text-center animated fadeInUp">
            <small class="text-muted">&copy; 后台管理系统</small>
        </div>
        <!-- END Login Footer -->
