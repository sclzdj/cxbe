...
window.LArea = (function() {
    ...
    MobileArea.prototype = {
        init: function(params) {
            ...
            this.trigger.value=params.trigger;
            if(params.valueTo){
                this.valueTo=document.querySelector(params.valueTo);
            }
            this.keys = params.keys || { id: 'value', name: 'text' };
        ...
        finish: function(e) {
            ...
            if(this.valueTo){
                $(this.valueTo).text(provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):('')))
            }else {
                $(_self.trigger).text(provinceText + ((cityText)?(',' + cityText):(''))+ ((countyText)?(',' + countyText):('')));
                $(_self.trigger).addClass("on")
            }
            _self.close(e);
