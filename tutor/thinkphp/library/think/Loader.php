...
class Loader
{
     ...
     * @throws ClassNotFoundException
     */
    public static function controller($name, $layer = 'home', $appendSuffix = false, $empty = '')
    {
        list($module, $class) = self::getModuleAndClass($name, $layer, $appendSuffix);
     ...
     * @return mixed
     */
    public static function action($url, $vars = [], $layer = 'home', $appendSuffix = false)
    {
        $info   = pathinfo($url);
     ...
     * @param  string $layer        层名 home model ...
